...
public class TraineeInitializer {
    Logger logger = LoggerFactory.getLogger(TraineeInitializer.class);
    ...
    public void setTraineeMap(@Qualifier("traineeMap") Map<Long, Trainee> traineeMap) {
        ...
        logger.info("Trainee map injected in TraineeInitializer");
    }

    @Autowired
    public void setTrainerMap(@Qualifier("trainerMap") Map<Long, Trainer> trainerMap) {
        this.trainerMap = trainerMap;
        logger.info("Trainer map injected in TraineeInitializer");
    }
    ...
    public Map<Long, Trainee> getTraineeMap() {
        logger.info("returned trainee map");
        return traineeMap;
    }
